...
const ITEMS = [
  { id: "divine_blessing", name: "Bênção Divina", image: "imgs/itens/item_divine_blessing.jpg", type: "Consumível" },
  { id: "havel_ring", name: "Anel de Havel", image: "imgs/itens/item_havel_ring.webp", type: "Anel" },
  { id: "estus_flask", name: "Frasco de Estus", image: "imgs/itens/item_flask_estus.webp", type: "Consumível" },
  { id: "claymore", name: "Claymore", image: "imgs/itens/claymore.png", type: "Arma" },
...
const SCENERY = [
  { id: "anor_londo", name: "Anor Londo", image: "imgs/cenarios/anor_londo.webp", type: "Local" },
  { id: "firelink_shrine", name: "Santuário de Firelink", image: "imgs/cenarios/cenario_firelink.jpg", type: "Local" },
  { id: "blighttown", name: "Cidade de Moléstia", image: "imgs/cenarios/cenario_blighttown.jpg", type: "Local" },
  { id: "majula", name: "Majula", image: "imgs/cenarios/majula.jpg", type: "Local" },
  { id: "central_yharnam", name: "Central Yharnam", image: "imgs/central_yharnam.jpg", type: "Local" },
  { id: "irithyll", name: "Irithyll of the Boreal Valley", image: "imgs/irithyll.jpg", type: "Local" },
  { id: "sens_fortress", name: "Sen's Fortress", image: "imgs/sens_fortress.jpg", type: "Local" },
  { id: "ash_lake", name: "Ash Lake", image: "imgs/ash_lake.jpg", type: "Local" },
  { id: "kiln_first_flame", name: "Kiln of the First Flame", image: "imgs/kiln_first_flame.jpg", type: "Local" },
  { id: "drangleic_castle", name: "Castelo de Drangleic", image: "imgs/drangleic_castle.jpg", type: "Local" },
  { id: "lothric_castle", name: "Castelo de Lothric", image: "imgs/lothric_castle.jpg", type: "Local" },
  { id: "fishing_hamlet", name: "Fishing Hamlet", image: "imgs/fishing_hamlet.jpg", type: "Local" },
  { id: "cainhurst", name: "Forsaken Cainhurst Castle", image: "imgs/cainhurst.jpg", type: "Local" },
...
const MUSIC = [
  ...
  { id: "ornstein_smough", name: "Ornstein & Smough", audio: "audio/Motoi Sakuraba - Ornstein & Smough.mp3", type: "Trilha Sonora" },
  { id: "artorias_theme", name: "Knight Artorias", audio: "audio/Motoi Sakuraba - Knight Artorias.mp3", type: "Trilha Sonora" },
  { id: "sif_theme", name: "Great Grey Wolf Sif", audio: "audio/Motoi Sakuraba - Great Grey Wolf Sif.mp3", type: "Trilha Sonora" },
  { id: "cleric_beast_theme", name: "Cleric Beast", audio: "audio/SIE Sound Team - Cleric Beast.mp3", type: "Trilha Sonora" },
  ...
  { id: "sir_alonne_theme", name: "Sir Alonne", audio: "audio/Yuka Kitamura - Sir Alonne.mp3", type: "Trilha Sonora" },
  { id: "fume_knight_theme", name: "Fume Knight", audio: "audio/Motoi Sakuraba - Fume Knight.mp3", type: "Trilha Sonora" },
  { id: "nameless_king_theme", name: "Nameless King", audio: "audio/Motoi Sakuraba - Nameless King.mp3", type: "Trilha Sonora" },
  ...
  { id: "firelink_ds1", name: "Firelink Shrine (DS1)", audio: "audio/Motoi Sakuraba - Firelink Shrine.mp3", type: "Trilha Sonora" },
  { id: "firelink_ds3", name: "Firelink Shrine (DS3)", audio: "audio/Yuka Kitamura - Firelink Shrine.mp3", type: "Trilha Sonora" },
  ...
  { id: "main_theme_bb", name: "Bloodborne (Main Theme)", audio: "audio/Bloodborne Soundtrack OST - Main Menu Theme.mp3", type: "Trilha Sonora" },
  { id: "first_hunter", name: "The First Hunter", audio: null, type: "Trilha Sonora" },
  { id: "Laurence_theme", name: "Laurence, the First Vicar", audio: "audio/SIE Sound Team - Laurence, the First Vicar.mp3", type: "Trilha Sonora" },
  ...
  { id: "vordt_theme", name: "Vordt of the Boreal Valley", audio: "audio/Motoi Sakuraba - Vordt of the Boreal Valley.mp3", type: "Trilha Sonora" },
